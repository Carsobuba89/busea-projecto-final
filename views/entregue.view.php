       ...
       <div class="header-container">
        ...
        <div class="body-container">
            ...
            <div class="body-content-right div-form1">
                ...
                <form action="<?= ROOT ?>/admin_entregas/entregueEncomenda" method="post">

                    <fieldset>
                        <legend>Regista a entregue da encomenda</legend>

                            <div class="form-group">
                                <div class="col-label">
                                    <label for="data_recebido">Data de entregue</label>
                                </div><!--.col-label-->
                                <div class="col-input">
                            ...
                            <div class="form-group">
                                <button type="submit" name="entregarEncomenda">Registrar Entregue</button>
                            </div>  
